...
with TAB_DEMO:
    ...
    with _mid:
        ...
        st.caption(
            ...
            "เกณฑ์ความมั่นใจ **" + format(TH, ".2f") + "** มาจาก §6.5b ของโน้ตบุ๊ก "
            "(Cost Matrix ที่คิดอัตราการติดหมวดผิดของเจ้าหน้าที่เข้าไปด้วย) — "
            "ที่เกณฑ์นี้ส่งอัตโนมัติ 62.4% ด้วยความแม่นยำ 93.3%"
        )
